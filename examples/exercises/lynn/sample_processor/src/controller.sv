...
module controller(
    ...
    always_comb
        case(OpD)
            // RegWriteD_ImmSrcD_ALUSrcD_ALUOpD_ALUResultSrcD_MemWriteD_ResultSrcD_BranchD_JumpD_MemEnD_MulD_AltSrcD_LoadD
            7'b0000011:         controls = 17'b1_000_01_0_0_0_01_0_0_1_0_0_1; // I-type load
            7'b0100011:         controls = 17'b0_001_01_0_0_1_00_0_0_1_0_0_0; // S-type
            7'b0110011: if (Funct7b0D)               controls = 17'b1_xxx_00_0_x_0_11_0_0_0_1_0_0; // R-type mul
                        else    controls = 17'b1_xxx_00_1_0_0_00_0_0_0_0_0_0; // R-type non-mul
            7'b0010011: if (Funct3D[1:0] == 2'b01)   controls = 17'b1_101_01_1_0_0_00_0_0_0_0_0_0; // I-type ALU uimm
                        else    controls = 17'b1_000_01_1_0_0_00_0_0_0_0_0_0; // I-type ALU
            7'b1100011:         controls = 17'b0_010_11_0_0_0_00_1_0_0_0_0_0; // B-type
            7'b1101111:         controls = 17'b1_011_11_0_1_0_00_0_1_0_0_1_0; // jal
    ...
    assign {RegWriteD, ImmSrcD, ALUSrcD, ALUOpD, ALUResultSrcD, MemWriteD,
        ResultSrcD, BranchD, JumpD, MemEnD, MulD, AltSrcD, LoadD} = controls;
