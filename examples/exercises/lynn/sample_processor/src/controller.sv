...
module controller(
    ...
    always_comb
        case(OpD)
            // RegWriteD_ImmSrcD_ALUSrcD_ALUOpD_ALUResultSrcD_MemWriteD_ResultSrcD_BranchD_JumpD_Load_MulD
            7'b0000011:         controls = 16'b1_000_01_0_0_0_001_0_0_1_0; // I-type load
            7'b0100011:         controls = 16'b0_001_01_0_0_1_000_0_0_1_0; // S-type
            7'b0110011: if (Funct7b0D)               controls = 16'b1_xxx_00_0_x_0_100_0_0_0_1; // R-type mul
                        else    controls = 16'b1_xxx_00_1_0_0_000_0_0_0_0; // R-type non-mul
            7'b0010011: if (Funct3D[1:0] == 2'b01)   controls = 16'b1_101_01_1_0_0_000_0_0_0_0; // I-type ALU uimm
    ...
    assign {RegWriteD, ImmSrcD, ALUSrcD, ALUOpD, ALUResultSrcD, MemWriteD,
        ResultSrcD, BranchD, JumpD, MemEnD, MulD} = controls;
